...
def plot_coordinates_on_image(img, coords, point_color=(0, 0, 255), point_radius=5):
...
def get_coordinates(img, evt: gr.SelectData):
    ...
    image_input2=img
    image_input2=plot_coordinates_on_image(image_input2, click_coordinates)
    return img, click_coordinates, combined_image,best_mask,image_input2
...
with gr.Blocks() as demo:
    ...
    with gr.Row():
        ...
        img_input2=gr.Image(type="pil", label="坐标可视化")
    ...
    img_input.select(get_coordinates, [img_input], [img_input, coordinates_display, img_mask,best_mask,img_input2])
